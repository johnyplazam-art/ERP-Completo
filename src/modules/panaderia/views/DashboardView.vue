  ...
  <div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      <div class="bg-white rounded-xl border border-gray-200 p-5">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-sm text-gray-500">{{ t('dashboard.activeRecipes') }}</p>
      ...
      <div class="bg-white rounded-xl border border-gray-200 p-5">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-sm text-gray-500">{{ t('dashboard.pendingOrders') }}</p>
            <p class="text-2xl font-bold text-gray-900 mt-1">
      ...
      <div class="bg-white rounded-xl border border-gray-200 p-5">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-sm text-gray-500">{{ t('dashboard.todayProduction') }}</p>
            <p class="text-2xl font-bold text-gray-900 mt-1">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
      <div class="bg-white rounded-xl border border-gray-200 p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ t('dashboard.productsByCategory') }}</h3>
        <div class="h-64" v-if="productos?.length">
          <Pie :data="productosPorCategoria" :options="chartOptions" />
        </div>
        <p v-else class="text-sm text-gray-400 text-center py-12">{{ t('dashboard.noData') }}</p>
      </div>
      <div class="bg-white rounded-xl border border-gray-200 p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ t('dashboard.ordersByDay') }}</h3>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div class="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div class="space-y-3">
          ...
          >
            ...
            <span class="text-sm font-medium text-gray-700">{{ t('dashboard.newRecipe') }}</span>
          </router-link>
          <router-link
          ...
          >
            ...
            <span class="text-sm font-medium text-gray-700">{{ t('dashboard.startProduction') }}</span>
          </router-link>
          <router-link
          ...
          >
            ...
            <span class="text-sm font-medium text-gray-700">{{ t('dashboard.registerMovement') }}</span>
          </router-link>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div v-if="loadingOrdenes" class="text-gray-400 text-sm">{{ t('dashboard.loading') }}</div>
        <div v-else-if="!ordenes?.length" class="text-gray-400 text-sm">{{ t('dashboard.noOrdersYet') }}</div>
